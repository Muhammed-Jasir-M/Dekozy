       ...
       children: [
        Row(
          ...
          children: [
            Row(
              children: [
                const CircleAvatar(backgroundImage: AssetImage(AImages.userProfileImage)),
                const SizedBox(width: ASizes.spaceBtwItems ), 
                Text('Niggawhohas3legs' , style: Theme.of(context).textTheme.titleLarge ),
              ],
            ),
        ...
        Row(
         ...
         const SizedBox(width: ASizes.spaceBtwItems),
         const ReadMoreText('I JUST LOVE THIS APP FROM BOTTOM OF MY HEART ' ,
         trimLines: 1,
          ...
          child: Column(
            children: [
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text("AURAKART" , style: Theme.of(context).textTheme.titleMedium),
